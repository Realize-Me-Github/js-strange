...
export declare function isComparableDate(
	value: any,
): value is ComparableDateObject;
export declare const isRangeLiteral: (
	v: any,
) => v is Range.RangeLiteral<Range.Endpoint>;
export declare const isNumericRangeLiteral: (
	v: any,
