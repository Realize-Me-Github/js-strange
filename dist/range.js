...
exports.BoundedRange =
	exports.Range =
	exports.isNumericRangeLiteral =
	exports.isRangeLiteral =
	exports.isComparableDate =
	exports.isNumericRange =
	exports.isRange =
		void 0;
...
var isNumericRangeLiteral = function (v) {
	return (
		(0, exports.isRangeLiteral)(v) &&
		isNumberOrNil(v.upper) &&
		isNumberOrNil(v.lower)
	);
};
...
var Range = (function () {
	...
	Range.prototype.toPostgres = function (prepare) {
		...
		var pgValue = ""
			.concat(this.bounds[0])
			.concat(this.pgFormatBound(this.begin, prepare), ",")
			.concat(this.pgFormatBound(this.end, prepare))
			.concat(this.bounds[1]);
		return pgValue;
	};
	Range.prototype.toDisplay = function () {
		...
		var _a = boundToMathSymbols(this.bounds),
			lower = _a.lower,
			upper = _a.upper;
		var parts = [];
	...
	Range.defaultValueParser = function (v) {
		return v;
	};
	return Range;
})();
